...
- Les fichiers .md *doivent* impérativement avoir une en-tête Jekyll (c-à-d. un `----` au début), même si elle est vide;<br/>
  elles apparaissent après sur github.io avec le même nom mais extension .html
- En particulier, cela s'applique pour index.md / index.html
  - aussi bien à la racine que dans les sous-répertoires
- Le thème par défaut est spécifié dans [_config.yml](https://github.com/m-f-h/OEIS/blob/main/pense-b%C3%AAte%20pages%20github.md) (ici: [Minima](https://jekyll.github.io/minima/about/))
